export const content = {
  en: {
    ...
    timeline: {
      title: "How it works",
      w1: "Week 1: Rhythmic Foundations",
      w2: "Week 2: Chord Transitions",
      w3: "Week 3: Vocal Isolation",
      w4: "Week 4: Jam Session",
      w5: "Week 5: Adding Dynamics",
      w6: "Week 6: Record Your 3 Songs"
    },
    social: {
  ...
  es: {
    ...
    timeline: {
      title: "Cómo funciona",
      w1: "Semana 1: Fundamentos Rítmicos",
      w2: "Semana 2: Transiciones de Acordes",
      w3: "Semana 3: Aislamiento Vocal",
      w4: "Semana 4: Zapada",
      w5: "Semana 5: Dinámicas",
      w6: "Semana 6: Graba Tus 3 Canciones"
    },
    social: {
